...
zabbixserver="172.20.200.245"
mydocker=`grep "mydockerhub.com" /etc/hosts`
if [ -z "$mydocker" ];then
   echo "120.92.36.114  mydockerhub.com" >>/etc/hosts
fi

if [ ! -f "mydockerhub.tar.gz" ];then
    ...
    tar -xzvf mydockerhub.tar.gz -C /etc/docker/cert.d/
fi
...
myzabbixreg="mydockerhub.com:5000/zabbix"
...
myrep=" mydockerhub.com:5000/grafana"
